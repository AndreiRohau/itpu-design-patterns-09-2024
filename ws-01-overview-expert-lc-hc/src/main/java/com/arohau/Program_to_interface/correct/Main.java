...
//        chineseTextEditorService.saveNewTextToDatabase("wo ai pu tong hua");
        ...
        TextEditorService generalPurposeTextEditorService = new TextEditorService();
        generalPurposeTextEditorService.saveNewTextToDatabase("some eng text", englishTextSpellingChecker);
        generalPurposeTextEditorService.saveNewTextToDatabase("some chi text", chineseTextSpellingChecker);
    }
}
